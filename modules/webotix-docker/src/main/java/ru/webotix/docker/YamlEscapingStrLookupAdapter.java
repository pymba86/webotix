...
/**
 * Adapter for {@link StrLookup}s which escapes the result for use in YAML. Note that it's assumed
 * the result will be replacing a value which is already expressed inside SINGLE quotes.
 */
